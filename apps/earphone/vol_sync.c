...
#if TCFG_ONE_CONN_VOL_SET
/*  -> 初始化音量设置，CONFIG_VOL_SCALE设置百分比(整数)*/
#define CONFIG_VOL_SCALE    6   
u8 need_default_volume = (127*CONFIG_VOL_SCALE/10); 
/*  -> sync_default_volume_every_time 改成0为下次开机记忆，1 下次开机不记忆*/
u8 sync_default_volume_every_time = 0 ;
