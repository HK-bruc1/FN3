...
const struct eq_seg_info eq_tab_normal[] = {
    ...
    {0, EQ_IIR_TYPE_HIGH_PASS, 60,    0, 0.6},
    {1, EQ_IIR_TYPE_BAND_PASS, 300,   -18, 0.3},
    {2, EQ_IIR_TYPE_BAND_PASS, 400,   -6, 0.5},
    {3, EQ_IIR_TYPE_BAND_PASS, 4000,   -3, 2},
    {4, EQ_IIR_TYPE_BAND_PASS, 500,    0, AUDIO_EQ_Q},
    {5, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
    {6, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
    {7, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
    {8, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
    {9, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
    //补足5组
   // {4, EQ_IIR_TYPE_BAND_PASS, 500,    4, AUDIO_EQ_Q},
};
  //
  const struct eq_seg_info eq_tab_rock[] = {
    ...
    {0, EQ_IIR_TYPE_BAND_PASS, 600,-18, 0.6},
    //补足5组
   {1, EQ_IIR_TYPE_BAND_PASS, 62,     0, AUDIO_EQ_Q},
   {2, EQ_IIR_TYPE_BAND_PASS, 125,    0, AUDIO_EQ_Q},
   {3, EQ_IIR_TYPE_BAND_PASS, 250,    0, AUDIO_EQ_Q},
...
const struct eq_seg_info eq_tab_pop[] = {
    ...
    {0, EQ_IIR_TYPE_HIGH_PASS, 60,     0, 1},
    {1, EQ_IIR_TYPE_LOW_SHELF, 120,    3, 0.9},
    {2, EQ_IIR_TYPE_BAND_PASS, 300,   -6, 0.3},
    {3, EQ_IIR_TYPE_BAND_PASS, 400,  -16, 0.3},
    {4, EQ_IIR_TYPE_BAND_PASS, 4000,  -3, 2},
    {5, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
    {6, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
    {7, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
    {8, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
...
const struct eq_seg_info eq_tab_country[] = {
    ...
    {2, EQ_IIR_TYPE_BAND_PASS, 400,  -6, 0.5},
    {3, EQ_IIR_TYPE_BAND_PASS, 4000, -3, 2},
    {4, EQ_IIR_TYPE_BAND_PASS, 2000,   6, 0.9},
    {5, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
    {6, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
    {7, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
    {8, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
...
const struct eq_seg_info eq_tab_jazz[] = {
    ...
    {2, EQ_IIR_TYPE_BAND_PASS, 400,   -6, 0.5},
    {3, EQ_IIR_TYPE_BAND_PASS, 4000,    -3, 2},
    {4, EQ_IIR_TYPE_LOW_SHELF, 200,    -6, 0.9},
    {5, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
    {6, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
    {7, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
    {8, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
...
const struct eq_seg_info eq_tab_classic[] = {
    ...
    {2, EQ_IIR_TYPE_BAND_PASS, 400,  -6, 0.5},
    {3, EQ_IIR_TYPE_BAND_PASS, 4000, -3, 2},
    {4, EQ_IIR_TYPE_HIGH_SHELF, 2500,  4, 2},
    {5, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
    {6, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
    {7, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
    {8, EQ_IIR_TYPE_BAND_PASS, 96000, 0, AUDIO_EQ_Q},
...
float type_gain_tab[EQ_MODE_MAX] = {-4, -4, -2, -4, -4, -4, 0};
#endif
...
{
     printf("----samson--------eq_type = %d----mode_num = %d----------------\n",eq_cfg->eq_type,eq_cfg->mode_num);
...
int eq_init(void)
{
    printf("eq_init----samson--------section_NUM -----------11---------\n");
...
#if EQ_FILE_CP_TO_CUSTOM
 printf("eq_init----samson--------section_NUM -----------222---------\n");
    parm.file_en = 1;
    ...
    if (eq_cfg) {
       ...
       // eq_cfg->type_gain_tab = type_gain_tab;
      //  eq_cfg->eq_type= EQ_TYPE_MODE_TAB;
#if defined(AUDIO_VBASS_CONFIG)&&AUDIO_VBASS_CONFIG
        eq_cfg->vbass = 1;
#endif
#if EQ_FILE_CP_TO_CUSTOM
        printf("eq_init----samson--------section_NUM -----------333--------\n");
