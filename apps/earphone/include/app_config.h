...
#define     MUTIl_CHARGING_BOX_EN    0  //added by samosn 
...
/*-----------子模块.data段配置START-----------*/
#define AUDIO_CVP_CODE_AEC_AT_RAM		0	//AEC 	     双麦 - 3k   单麦 - 0.3k
#define AUDIO_CVP_CODE_NLP_AT_RAM		0   //NLP
#define AUDIO_CVP_CODE_NS_AT_RAM		0	//ANS/下行降噪      1.1k
#define AUDIO_CVP_CODE_DNS_AT_RAM		0	//DNS               20.4k
#define AUDIO_CVP_CODE_WIND_AT_RAM		0   //WIND
#define AUDIO_CVP_CODE_DMS_AT_RAM		0	//双麦DMS           3.2k
#define AUDIO_CVP_CODE_AGC_AT_RAM		0	//AGC               0.6k
#define AUDIO_CVP_CODE_COMMON_AT_RAM	0	//common lib 双麦 - 2.8k 单麦 - 4k
#define AUDIO_CVP_CODE_TEXT_AT_RAM		0	//common text 下行降噪开 - 6.9k 下行降噪关 - 4.6k
/*-----------子模块.data段配置END-------------*/
