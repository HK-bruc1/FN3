...
#define PWM_LED_TWO_IO_CONNECT			     1  //两个IO LED 接法: 0->一端接地 , 1->一端接高
...
#define CFG_SINGLE_SLOW_FLASH_FREQ			3000	//LED单独慢闪速度, ms闪烁一次(1000 ~ 20000)
...
#define CFG_LED0_BREATH_BRIGHT 				400			//呼吸亮度, 范围: 0 ~ 500
#define CFG_LED1_BREATH_BRIGHT 				400			//呼吸亮度, 范围: 0 ~ 500
