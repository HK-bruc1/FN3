...
{
    syscfg_write(CFG_RCSP_ADV_EQ_MODE_SETTING, eq_mode, 1);
}

u8 get_eq_mode(void)
{
      u8 eq_setting_mode = 0;
      syscfg_read(CFG_RCSP_ADV_EQ_MODE_SETTING, &eq_setting_mode, sizeof(eq_setting_mode));
      return eq_setting_mode;
}
