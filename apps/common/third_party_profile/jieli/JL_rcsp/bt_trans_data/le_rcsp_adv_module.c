...
static uint16_t att_read_callback(hci_con_handle_t connection_handle, uint16_t att_handle, uint16_t offset, uint8_t *buffer, uint16_t buffer_size)
{
    ...
    switch (handle) {
    case ATT_CHARACTERISTIC_00000104_A812_1000_8000_00805f9b34fb_01_VALUE_HANDLE:
    case ATT_CHARACTERISTIC_00000104_A811_1000_8000_00805f9b34fb_01_VALUE_HANDLE :
    ...
    case ATT_CHARACTERISTIC_00000104_A802_1000_8000_00805f9b34fb_01_CLIENT_CONFIGURATION_HANDLE:
        if (buffer) {
...
static int att_write_callback(hci_con_handle_t connection_handle, uint16_t att_handle, uint16_t transaction_mode, uint16_t offset, uint8_t *buffer, uint16_t buffer_size)
{
    ...
    case ATT_CHARACTERISTIC_00000104_A802_1000_8000_00805f9b34fb_01_CLIENT_CONFIGURATION_HANDLE:
        ...
        can_send_now_wakeup();
        break;
    case ATT_CHARACTERISTIC_00000104_A801_1000_8000_00805f9b34fb_01_VALUE_HANDLE:
...
static int make_set_adv_data(void)
{
    ...
    buf[0] = 0x0E;
    buf[1] = 0xFF;
    rcsp_adv_fill_mac_addr(&buf[2]);
    buf[8] = 0x01;
    buf[9] = 0x04;//0x01

    //memset(&buf[10], 0x00, 3);							// reserve
  
    usFwversion = get_vid_pid_ver_from_cfg_file(GET_VER_FROM_EX_CFG);
    buf[10] = 1;
    buf[11] = (u8)((usFwversion&0xFF00)>>8);
    buf[12] =  (u8)(usFwversion&0x00FF);
    buf[13] = 0x4A;
    buf[14] = 0x52;
    __this->modify_flag = 0;
    adv_data_len = 15;
    ble_user_cmd_prepare(BLE_CMD_ADV_DATA, 2, 15, buf);
    #endif
    r_printf("-----samson----ADV data():---------");
    put_buf(buf, 15);
    return 0;
}
...
static int make_set_rsp_data(void)
{
    ...
    u8  str[] = "JOYROOM FN3";
    u8 *edr_name =(const char*)str;//bt_get_local_name();//added by samson on 20250422
...
#endif
    return app_send_user_data(ATT_CHARACTERISTIC_00000104_A802_1000_8000_00805f9b34fb_01_VALUE_HANDLE, data, len, ATT_OP_AUTO_READ_CCC);
}
...
// check if change
    ...
    /* buf[17] = __this->bat_percent_R ? (((!!__this->bat_charge_R) << 7) | (__this->bat_percent_R & 0x7F)):0; */
    /* buf[18] = __this->bat_percent_C ? (((!!__this->bat_charge_C) << 7) | (__this->bat_percent_C & 0x7F)):0; */
    //DhfAppCommand_DataNotify(EM_COMM_BATTERY_CHANGE_DEVICE_SEND);
    return tchange;
}
...
{
    if (!ATT_CHARACTERISTIC_00000104_A802_1000_8000_00805f9b34fb_01_VALUE_HANDLE) {
        return -1;
    }
    return app_send_user_data(ATT_CHARACTERISTIC_00000104_A802_1000_8000_00805f9b34fb_01_VALUE_HANDLE, data, len, ATT_OP_AUTO_READ_CCC);
}
