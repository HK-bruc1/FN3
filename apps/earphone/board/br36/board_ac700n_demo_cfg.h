...
//多少个IO控制LED 
#define LED_IO_CHOOSE                           1//2

//首次链接设备设置固定音量
#define TCFG_ONE_CONN_VOL_SET                   1 

//满电关闭内置触摸(省功耗)
#define TCFG_CHARGEFULL_LP_TOUCH_DISABLE        1  

#define   CHARGE_FULL_LED_TIME                 30  //满电后亮灯持续时长，30秒
//                                 UART配置                                        //
//*********************************************************************************//
...
#define TCFG_AUDIO_MIC_PWR_CTL				MIC_PWR_FROM_GPIO//MIC_PWR_FROM_MIC_LDO | MIC_PWR_FROM_GPIO
#else
...
#define TCFG_AUDIO_MIC1_PWR_PORT			IO_PORTB_02
...
#define EQ_SECTION_MAX                            10     //eq 段数，最大20//此10不能更改，否则EQ会出问题
...
#else
#define CONFIG_BT_CALL_HZ		        (128 * 1000000L)//(48 * 1000000L)
#define CONFIG_BT_CALL_ADVANCE_HZ       (128 * 1000000L)//(60 * 1000000L)
#define CONFIG_BT_CALL_16k_HZ	        (128 * 1000000L)//(70 * 1000000L)
