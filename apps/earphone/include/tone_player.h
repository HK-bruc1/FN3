...
#define TONE_ANC_OFF			SDFILE_RES_ROOT_PATH"tone/du.*"//SDFILE_RES_ROOT_PATH"tone/anc_off.*"
...
#define TONE_LOW_LATENCY_IN     	SDFILE_RES_ROOT_PATH"tone/game_mode.*"//DEFAULT_SINE_TONE(SINE_WTONE_LOW_LATENRY_IN)
...
#define TONE_DU                 SDFILE_RES_ROOT_PATH"tone/du.*"
#define TONE_DUDU               SDFILE_RES_ROOT_PATH"tone/dudu.*"
